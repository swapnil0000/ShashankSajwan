  ...
  return (
    <Box>
      ...
      {isMobileView && (
        ...
        <Tab label="Economical" {...a11yProps(1)} sx={{ bgcolor: value === 1 ? 'lightblue' : 'white', color: 'black', marginRight: '10px', marginBottom: '10px',marginLeft:'10px', borderRadius: '8px', width: isMobileView ? "90%" : "200px", boxShadow: 'rgba(0, 0, 0, 0.24) 0px 3px 8px' }} />

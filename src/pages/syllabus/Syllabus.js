...
import noteslogo from "../Materials/notelogo.png"
...
const Syllabus=() =>{
  ...
  return (
    <Box>
    <Typography sx={{marginTop:'120px',display:'flex',flexDirection:'row',justifyContent:'center',fontSize:'40px',fontWeight:'600'}}>SYLLABUS</Typography>
    <Box
    ...
    >
      <Tabs
        ...
        sx={{height:isMobileView?"180px":"600px",marginLeft:'10px' ,padding:'10px',width:isMobileView?"100%":"260px",display:'flex',alignItems:'center',justifyContent:'center', backgroundColor:'#212529',borderRadius:'10px'}}
      >
      <Tab label="Prelims" {...a11yProps(0)} sx={{ bgcolor: value === 0 ? 'lightblue' : 'white',fontWeight:'600',color:'black',marginBottom:'20px',borderRadius:'8px',width:'200px' ,marginTop:'10px'}} />
      <Tab label="Mains" {...a11yProps(1)} sx={{ bgcolor: value === 1 ? 'lightblue' : 'white' ,color:'black',marginBottom:'20px',borderRadius:'8px',width:'200px' }} />
      </Tabs>

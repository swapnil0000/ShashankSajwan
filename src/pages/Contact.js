    ...
    <Container sx={{ display: 'flex', flexDirection: 'column', marginTop: '100px', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: isMobileView ? "column" : "row", marginTop: isMobileView ? "10px" : "70px", width: '100%', alignItems: 'center', justifyContent: isMobileView ? "center" : "space-between" }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <TextField
            ...
            label="Email"
            variant='standard'
            value={contactDetails.fromEmail}
            onChange={handleChange}
          />
      ...
      <Box sx={{ marginTop: '30px', display: 'flex', flexDirection: 'column', marginBottom: '60px' }}>
        ...
        <Typography sx={{ fontSize: isSmallMobileView ? '15px' : '20px', marginTop: '5px' }}>For correspondence, kindly reach out to us at <span style={{ fontWeight: '600' }}>ask.iasmentor@gmail.com. </span>
          <Typography sx={{ fontSize: isSmallMobileView ? '15px' : '20px', marginTop: '10px',textAlign:'justify',hyphens:'inherit' }}>All email communications are managed and responded to by our Head Office located in Dehradun.</Typography> Should you seek guidance on Civil Services Exam preparation or wish to share your feedback/suggestions for us, we welcome you to send us an email.</Typography>
      </Box>
